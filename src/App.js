...
class App extends Component {
  state= {
    ...
    //this helps to render our components after we have retrieve the user objects from storage
...
//get session from local storage
  async componentDidMount(){
      try {
        //load session object from local storage and refresh the token when necessary
        ...
        <Router>
          <div>
            ...
            <Switch>
              ...
              <Route exact path="/admin" Productsrender={(props)=> <ProductAdmin {...props} auth={authProps} /> } />
